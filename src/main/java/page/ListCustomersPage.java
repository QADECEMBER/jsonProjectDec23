...
public class ListCustomersPage extends BasePage{
	...
	@FindBy(how = How.XPATH, using = "//tbody/tr[1]/td[9]/a[1]") WebElement EDIT_BUTTON_ELEMENT;
	@FindBy(how = How.XPATH, using = "//tbody/tr[1]/td[9]/a[2]") WebElement VIEW_BUTTON_ELEMENT;
	@FindBy(how = How.XPATH, using = "//*[@id=\"DataTables_filter\"]") WebElement SEARCH_LIST_CUSTOMERS_ELEMENT;
