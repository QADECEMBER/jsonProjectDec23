...
//				.getAsJsonObject().get("ValidationTextLogin").getAsString(),"Dashboard page is not available!");
//		dashboardPage.clickOnCustomer();
//		dashboardPage.clickOnAddCustomer();
//		
//		AddCustomerPage addCustomerPage = PageFactory.initElements(driver, AddCustomerPage.class);
//		Assert.assertEquals(
//				addCustomerPage.getNewCustomerValidaitonText(), jsonEleObj.getAsJsonObject().get("AddContact").getAsJsonObject().get("ValidationTextAddCustomer")
//				.getAsString(), "Add Customer page not found!!");
//		
//		
...
//				.getAsJsonArray().get(0).getAsJsonObject().get("Country").getAsString());       //for country 1(Antarctica)
//		
//	//	addCustomerPage.selectCountry(jsonEleObj.getAsJsonObject().get("AddContact").getAsJsonObject().get("Address")
//		//		.getAsJsonArray().get(1).getAsJsonObject().get("Country").getAsString()); //for country2 (Australia)
//
